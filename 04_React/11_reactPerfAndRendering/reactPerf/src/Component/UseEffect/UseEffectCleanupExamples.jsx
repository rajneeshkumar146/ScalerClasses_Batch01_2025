...
function UseEffectCleanupExamples() {
    ...
    function firstCb() {
        ...
        // In an ideal world we are not suppose to clean up firstUseEffect and try to write our code in a way that it will atomatically clean all the things that we used during development.
        return function () {
            console.log("First Use Effect cleanup");
        }
    }
